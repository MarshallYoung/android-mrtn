package com.yuchengtech.mrtn.predict.adapter;
 ...
 * 查询预计上门工单
 */
public class QueryPredictAdapter extends BaseAdapter {

    private Context context;
    private List<OrderInfo> list;

    public QueryPredictAdapter(OrderListActivity orderListActivity,
                               List<OrderInfo> orders) {
        this.context = orderListActivity;
        this.setList(orders);
    }

    public QueryPredictAdapter(QueryPredictActivity orderPredictListActivity,
