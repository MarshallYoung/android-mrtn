package com.yuchengtech.mrtn.Zxing;
...
import com.yuchengtech.mrtn.Zxing.camera.CameraManager;
import com.yuchengtech.mrtn.Zxing.decoding.CaptureActivityHandler;
import com.yuchengtech.mrtn.Zxing.decoding.InactivityTimer;
import com.yuchengtech.mrtn.Zxing.decoding.RGBLuminanceSource;
import com.yuchengtech.mrtn.Zxing.decoding.Utils;
import com.yuchengtech.mrtn.Zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (result == null) {
                                ...
                                if (!TextUtils.isEmpty(result.getBarcodeFormat()
                                        .toString())) {
                                    String mBarcodeFormat = result
                                ...
                                // Log.i("---> (1一维码、  2、二维码    3、其他码) ",""+CODE_TYPE);
                                // 数据返回
    ...
    public void handleDecode(final Result result, Bitmap barcode) {
        ...
        Intent data = new Intent();
        data.putExtra("result", recode);
        data.putExtra("code_type", CODE_TYPE);
        setResult(300, data);
        finish();
    }
