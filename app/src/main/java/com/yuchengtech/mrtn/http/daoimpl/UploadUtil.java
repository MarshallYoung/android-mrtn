 ...
 * 上传工具类
 */
public class UploadUtil implements YXAPI {
    /***
     * 上传成功
     */
    ...
    private static final String action = "servlet/Upload";
     ...
     */
    public void uploadFile(String filePath, String fileKey,
    ...
    public void uploadFile(final File file, final String fileKey,
        ...
        new Thread(new Runnable() { // 开启线程上传文件
            @Override
            public void run() {
                toUploadFile(file, fileKey, param);
            }
        }).start();
    ...
    private void toUploadFile(File file, String fileKey,
        ...
        try {
            ...
            // 设置是AndroidAPP应用请求
            conn.setRequestProperty("android_request", "1");
            conn.setRequestProperty("connection", "keep-alive");
            conn.setRequestProperty("user-agent",
                    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1)");
            conn.setRequestProperty("Content-Type", CONTENT_TYPE + ";boundary="
                    + BOUNDARY);
            conn.setRequestProperty("Cookie", "sid=" + MrtnApplication.sid);
